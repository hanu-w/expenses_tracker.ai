...
class SettingsView(ctk.CTkFrame):
    ...
    def _build_ui(self):
        ...
        ctk.CTkLabel(
            ...
            font=FONTS["small"],
            text_color=self.theme.get("text_muted", "#5a5a6a"), anchor="w"
        ).pack(fill="x")
        ...
        self.theme_switch.pack(side="right", padx=(16, 0))
        ...
        budget_inner.pack(fill="x", padx=20, pady=16)
        ...
        self.budget_entry = ctk.CTkEntry(
            ...
            font=FONTS["body"], width=200, height=40, corner_radius=10,
            fg_color=self.theme.get("input_bg", "#16162a"),
        ...
        save_btn = ctk.CTkButton(
            ...
            text_color="#ffffff", width=80, height=40, corner_radius=10,
            command=self._on_save_budget,
        )
        save_btn.pack(side="left")

        self.budget_msg = ctk.CTkLabel(
            budget_inner, text="", font=FONTS["small"],
            text_color=self.theme.get("success", "#00cec9"),
        )
        self.budget_msg.pack(fill="x", pady=(8, 0))
        ...
        ctk.CTkLabel(
            ...
            font=FONTS["body"],
            text_color=self.theme.get("text_secondary", "#8a8a9a"), anchor="w"
        ...
        for line in info_lines:
            ctk.CTkLabel(
                ...
                font=FONTS["small"] if line else FONTS["tiny"],
                text_color=self.theme.get("text_secondary", "#8a8a9a") if line else "transparent",
                anchor="w"
            ).pack(fill="x", pady=1)
